...
def main():
    while True:
        try:
            print("Looking for Fleetmaster")
            box = py.locateOnWindow("FleetmasterPrinter/img/Fleetmaster1.png", confidence=0.2)
            ...
            try:
                print("Looking for Fleetmaster")
                box = py.locateOnWindow("FleetmasterPrinter/img/Fleetmaster2.png", confidence=0.2)
                center = py.center(box)
                py.moveTo(center.x, center.y)
                py.click()
                time.sleep(2)
...
def func(arr_of_regs):
    ...
    for reg in arr_of_regs:
        ...
        while not found:
            try:
                box = py.locateOnScreen("FleetmasterPrinter/img/Fleetmaster1.png", confidence=0.2)
                center = py.center(box)
                py.moveTo(center.x, center.y)
                py.click()
                found = True
